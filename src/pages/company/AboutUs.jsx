    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full relative z-10">
          ...
          <div className="text-left max-w-[600px]">
            ...
            <h3 className="text-xl md:text-2xl font-semibold mb-6 text-blue-100 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              Performance. Precision. Possibility.
            </h3>

            <p className="text-gray-200 text-md md:text-lg leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative group w-full max-w-[420px] h-[260px] sm:h-[300px] md:h-[340px] flex items-center justify-center animate-float" style={{ animationDelay: "0.3s" }}>
              {/* Image Glow */}
      ...
      <section
        ...
        className={`py-20 bg-white transition-all duration-700 ease-out ${
          visibleSections.who ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6 text-gray-700 mt-10">
            <p className="text-lg leading-relaxed animate-fade-in-left" style={{ animationDelay: "0.1s" }}>
              We are strategists, analysts, storytellers, technologists, and growth architects.
            </p>
            <p className="text-lg leading-relaxed animate-fade-in-left" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-lg font-semibold text-gray-900 mt-6 animate-fade-in-left" style={{ animationDelay: "0.3s" }}>
              Our approach blends:
            </p>
            <ul className="space-y-3 text-lg font-medium">
              {[
                ...
                <li key={i} className="flex items-start gap-4 animate-fade-in-left" style={{ animationDelay: `${0.4 + i * 0.1}s` }}>
                  <span className="text-green-600 text-xl mt-1">✔</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
            <p className="text-lg leading-relaxed pt-4 animate-fade-in-left" style={{ animationDelay: "0.9s" }}>
              We work with startups, SMEs, and growing enterprises to transform digital channels into predictable revenue
              engines.
            </p>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-xl text-gray-700 font-medium animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              Visibility is easy to promise. <br />
              <span className="text-gray-900 font-semibold">Impact is harder to deliver.</span>
            </p>
            <p className="text-lg text-gray-600 mt-6 leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 animate-fade-in-up">Our Core Expertise</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className={`${card.bg} ${card.text} p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 animate-fade-in-up`}
      ...
      <section
        ...
        className={`py-8 bg-gray-50 transition-all duration-700 ease-out ${
          visibleSections.working ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 animate-fade-in-up">Our Working Model</h2>
            <p className="text-lg text-gray-600 mt-4 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 animate-fade-in-up">Our Vision & Mission</h2>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div>
            <h2 className="text-4xl font-bold text-center mb-4 animate-fade-in-up">Industries We Serve</h2>
            <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
      ...
      <section
        ...
        className={`py-24 px-6 bg-gray-50 transition-all duration-700 ease-out ${
          visibleSections.partner ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-8 animate-fade-in-right">Why Partner With Us?</h2>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start gap-4 animate-fade-in-right" style={{ animationDelay: `${0.1 + index * 0.1}s` }}>
                    <span className="text-green-600 text-xl mt-1">✔</span>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-blue-100 leading-relaxed mb-10 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="text-lg text-blue-200 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="mt-12 animate-scale-in" style={{ animationDelay: "0.4s" }}>
            <button
