...
//     <>
//       <section
//         className="bg-cover bg-center bg-no-repeat py-16 md:py-20 bg-slate-900"
//         style={{
//           backgroundImage:
...
//               <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-gray-900 text-base">
...
//           {/* PARAGRAPH */}
//           <div className="text-gray-600 mt-6 text-lg leading-relaxed max-w-4xl mx-auto">
