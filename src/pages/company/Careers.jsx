    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h3 className="text-4xl md:text-xl font-bold text-black leading-tight animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              managed by Clink Consultancy Services pvt. ltd?
            </h3>
            <p className="text-gray-700 mt-4 text-lg leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-16">
            ...
            <div className="flex justify-center lg:justify-end mt-10 lg:mt-0 animate-float" style={{ animationDelay: "1s" }}>
              <img
          ...
          <div className="w-24 h-1 mx-auto bg-gradient-to-r from-blue-500 to-orange-400 rounded-full mt-16 mb-6 animate-fade-in-up" style={{ animationDelay: "1.2s" }}></div>
          <p className="text-gray-500 text-lg font-medium italic text-center max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: "1.3s" }}>
      ...
      <section
        ...
        className={`relative py-20 overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50 to-white transition-all duration-700 ease-out ${
          visibleSections.culture ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="w-24 h-1 mx-auto bg-gradient-to-r from-blue-500 to-orange-400 rounded-full mt-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}></div>
          <p className="text-gray-600 mt-6 text-lg leading-relaxed max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            At Adkryoss managed by Clink Consultancy Services pvt. ltd, culture is not a slogan — it's a system.
          </p>
          <p className="text-blue-600 font-bold mt-2 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>We believe in:</p>
      ...
      <section
        ...
        className={`py-14 bg-white transition-all duration-700 ease-out ${
          visibleSections.looking ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-4 text-lg leading-relaxed animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 mt-12">
            ...
            <div className="w-full lg:w-1/2 flex justify-center animate-float" style={{ animationDelay: "1s" }}>
              <img
          ...
          <p className="text-gray-600 mt-12 text-lg font-medium text-center animate-fade-in-up" style={{ animationDelay: "1.2s" }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-600 mt-4 text-lg font-bold animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              We look for:
            </p>
          </div>
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 flex justify-center animate-float" style={{ animationDelay: "0.3s" }}>
              <img
          ...
          <p className="text-gray-600 mt-16 text-lg font-medium italic text-center animate-fade-in-up" style={{ animationDelay: "1.2s" }}>
        ...
        <div className="max-w-[1500px] mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-gray-700 mt-6 text-lg leading-relaxed max-w-4xl animate-fade-in-right" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="flex justify-center lg:justify-end animate-float" style={{ animationDelay: "0.8s" }}>
              <img
                src={GrowthImage}
      ...
      <section
        ...
        className={`py-24 bg-gradient-to-br from-white via-blue-50 to-white transition-all duration-700 ease-out ${
          visibleSections.life ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-3 text-lg font-medium animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              Managed by Clink Consultancy Services pvt. ltd
            </p>
          </div>
          <p className="text-center text-gray-700 text-lg max-w-3xl mx-auto mt-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
      ...
      <section
        ...
        className={`py-0 bg-gray-50 transition-all duration-700 ease-out ${
          visibleSections.openings ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="overflow-x-auto bg-white rounded-2xl shadow-lg animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
      ...
      <section
        ...
        className={`py-28 bg-white transition-all duration-700 ease-out ${
          visibleSections.internship ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 mt-5 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center animate-float" style={{ animationDelay: "0.7s" }}>
              <img
                src={InternshipImage}
      ...
      <section
        ...
        className={`relative py-28 overflow-hidden transition-all duration-700 ease-out ${
          visibleSections.career ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 mt-4 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
      ...
      <section
        ...
        className={`py-12 bg-gray-50 transition-all duration-700 ease-out ${
          visibleSections.diversity ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="max-w-6xl mx-auto px-6">
          <div
            className="group relative rounded-2xl p-[2px] bg-gradient-to-r from-blue-600 via-orange-500 to-blue-600 bg-[length:200%_200%] animate-borderMove transition-all duration-500 hover:-translate-y-2 animate-fade-in-up"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 items-center gap-16">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed animate-fade-in-right" style={{ animationDelay: "0.1s" }}>
              ...
              <div className="space-y-3 text-lg font-semibold text-gray-800 mb-8">
                {["Real responsibility", "Real impact", "Real growth", "Real skill acceleration"].map((item, idx) => (
                  <p key={idx} className="animate-fade-in-right" style={{ animationDelay: `${0.2 + idx * 0.1}s` }}>✔ {item}</p>
                ))}
              </div>
              <a
              ...
              <p className="mt-6 text-gray-600 animate-fade-in-up" style={{ animationDelay: "0.7s" }}>
                Send your resume to: 
                <a
                  href="mailto:careers@adkryoss.com"
              ...
              <p className="text-gray-600 mt-2 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>Or connect with us on LinkedIn.</p>
            </div>
          </div>
        </div>
      </section>
