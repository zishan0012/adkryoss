...
const B2BCRO = () => {
    ...
    const industries = ["BFSI & FinTechnology", "Healthcare & Pharmacy", "SaaS & Technology", "Manufacturing & Industrial", "Education & EdTech", "Real Estate & Infrastructure"];
                            ...
                            <div className="space-y-6">
                                {process.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <span className="font-semibold text-blue-300 mr-2 uppercase text-sm tracking-widest">{item.step}:</span>
