        ...
        <div className="bg-white text-slate-900">
            ...
            >
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full">
                    ...
                    <div className="text-left relative z-10 text-white">
                        ...
                        <p className="text-[18px] leading-[1.8] text-[#555] text-white mb-8">
                    ...
                    <div className="flex justify-center md:justify-end relative z-10">
                        <img
                            src="https://www.techmagnate.com/wp-content/uploads/2026/01/Content-Writing.webp"
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white p-10 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-slate-100 mb-12 transition-all duration-300 hover:shadow-xl">
                            ...
                            <div className="p-8 bg-blue-500 rounded-xl text-white shadow-lg">
                                <p className="text-[20px] font-semibold text-white leading-relaxed mb-0 italic">
                    ...
                    <div className="flex flex-wrap justify-center gap-10">
                        {approaches.map((item, index) => (
                            <div key={index} className="bg-white border-2 border-slate-100 rounded-2xl p-8 transition-all duration-300 w-full md:w-[calc(50%-20px)] min-w-[300px] max-w-[550px] grow cursor-pointer group hover:border-[#0066CC] hover:-translate-y-3 hover:scale-[1.01] hover:shadow-[0_20px_40px_rgba(0,102,204,0.15)]">
                                ...
                                {item.subtitle && (
                                    <p className="text-[18px] text-[#0066CC] font-semibold mb-4">{item.subtitle}</p>
                                )}
            ...
            <section className="py-24 bg-slate-900 text-white">
                <div className="container">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-[18px] text-white font-medium italic">Bespoke content ecosystems for every industry.</p>
                    </div>
                    <div className="flex flex-wrap justify-center gap-8">
                        {contentTypes.map((type, index) => (
                            <div key={index} className="p-10 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 cursor-pointer group hover:-translate-y-2 w-full md:w-[calc(33.333%-22px)] min-w-[300px] max-w-[380px] grow">
                                ...
                                <h3 className="text-[22px] font-semibold mb-4 text-white uppercase tracking-tight group-hover:text-blue-400 transition-colors leading-tight">
                                    {type.title}
                                </h3>
            ...
            <section className="py-24 bg-white">
                <div className="container text-center">
                    ...
                    <p className="text-[20px] text-[#0066CC] font-bold mb-12">Content should:</p>
                ...
                <div className="container">
                    <div className="grid md:grid-cols-2 gap-20">
                        ...
                        <div>
                            ...
                            <p className="mt-10 text-[20px] font-bold text-[#0066CC] italic leading-tight">
                        ...
                        <div>
                            ...
                            <p className="mt-10 text-[18px] text-slate-600 font-bold italic text-right leading-tight">
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="container">
                    ...
                    <div className="mt-20 p-10 bg-slate-900 rounded-[40px] text-center text-white relative">
                        ...
                        <p className="text-xl text-white max-w-3xl mx-auto leading-relaxed mb-6 font-medium">
                        ...
                        <p className="text-lg font-bold text-white max-w-2xl mx-auto leading-relaxed">
            ...
            <section className="py-24 bg-gradient-to-br from-[#0066CC] to-[#004999] text-white text-center">
                <div className="container">
                    ...
                    <p className="text-[20px] mb-10 text-white max-w-3xl mx-auto font-medium">
