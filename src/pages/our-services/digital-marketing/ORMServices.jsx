...
import { Search, TrendingUp, Activity, Rocket, PenTool, Eye, CheckCircle, CheckCircle2 } from 'lucide-react';
...
>
  <div className="relative z-10 container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4">
     ...
     <div className="flex justify-center lg:justify-end mt-10 lg:mt-0">
      ...
      <section id="services" className="px-8 md:px-16 lg:px-24 py-14 bg-gray-50">
