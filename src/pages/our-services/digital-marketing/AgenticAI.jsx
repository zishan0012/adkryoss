...
import AgenticAlinDigitalMarketingImage from "../../../assets/AgenticAlinDigitalMarketing.png"
import WhyBusinessesChooseAgenticAlMarketingImage from "../../../assets/WhyBusinessesChooseAgenticAlMarketing.png"
import AlBecomeYourGrowthEngineImage from "../../../assets/AlBecomeYourGrowthEngine.png"
import {
  Cpu,
  Database,
  Rocket,
...
<section className="bg-white py-10 px-6 md:px-16 lg:px-4 mx-4 md:mx-10 lg:mx-20 rounded-xl my-16">
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
      <img
        src={AgenticAlinDigitalMarketingImage} alt="Agentic AI in Digital Marketing"
...
<section className="bg-white py-10 px-6 md:px-16 lg:px-4 mx-4 md:mx-10 lg:mx-20 rounded-xl my-16">
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
      <img
        src={WhyBusinessesChooseAgenticAlMarketingImage}  alt="Agentic AI Business Growth"
        className="rounded-xl shadow-lg w-full h-auto object-cover"
      />
    </div>
...
<section className="w-full bg-gradient-to-r from-[#0f172a] to-[#1e293b] py-14 px-6 md:px-16 lg:px-4 text-white">
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
    ...
    <div className="flex justify-center md:justify-end">
      <img
        src={AlBecomeYourGrowthEngineImage} alt="Agentic AI Growth"
