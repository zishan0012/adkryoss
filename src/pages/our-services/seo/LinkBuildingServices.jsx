  ...
  <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full relative z-10">
    ...
    <div ref={heroContentRef} className="text-left max-w-[600px]">
      ...
      <p className="text-gray-200 text-md md:text-lg leading-relaxed mb-4">
        Build powerful, high-authority backlinks that strengthen search visibility,
        improve domain credibility, and drive consistent organic growth.
        <br /><br />
        We create link ecosystems that search engines trust —
        and competitors struggle to match.
      </p>
      ...
      <p className="text-lg leading-relaxed text-white font-medium mb-6">
        ...
        </span>, we don’t chase links. We build digital authority.
      </p>
