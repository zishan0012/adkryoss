  ...
  <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full relative z-10">
    ...
    <div ref={heroContentRef} className="text-left max-w-[600px]">
      ...
      <p className="text-gray-200 text-md md:text-lg leading-relaxed mb-4">
        AI platforms are redefining discovery. If your business isn't optimized
        for Large Language Models (LLMs) like ChatGPT and Gemini,
        you are invisible in the next generation of search.
        <br /><br />
        We ensure your brand becomes a trusted, cited answer.
      </p>
      ...
      <p className="text-lg leading-relaxed text-white font-medium mb-6">
        ...
        </span>, we future-proof your digital presence for AI-driven discovery.
      </p>
