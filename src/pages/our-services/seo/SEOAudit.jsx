                ...
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full relative z-10">
                    ...
                    <div ref={heroContentRef} className="text-left max-w-[600px]">
                        ...
                        <p className="text-gray-200 text-md md:text-lg leading-relaxed mb-4">
                            Your traffic drop isn’t random. Your competitors aren’t lucky.
                            Growth starts with clarity — and clarity starts with a powerful SEO Audit.
                        </p>
                        ...
                        <p className="text-lg leading-relaxed text-white font-medium mb-6">
                            ...
                            </span>, we go beyond surface-level checks.
                            <br /><br />
                            We uncover hidden technical issues, content gaps, structural weaknesses,
                            and authority leaks that silently block your rankings.
                        </p>
                ...
                <div className="container">
                    ...
                    <div className="flex flex-wrap justify-center gap-[40px]">
                        {auditFramework.map((phase, i) => (
                            ...
                            >
                                <div className="mb-[20px] pr-[10px]">
                                    <div className="text-[#0066cc] card-icon">{phase.icon}</div>
                                </div>
