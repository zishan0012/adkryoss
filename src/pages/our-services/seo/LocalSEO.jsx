    ...
    return (
        <div style={{ backgroundColor: '#fff' }}>
                    ...
                    <div className="text-left relative z-10">
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.05)', padding: '24px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
                            <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#fff', margin: 0 }}>
                                At Adkryoss managed by <span style={{ fontWeight: '700', color: '#000' }}>Clink Consultancy Services Private Limited</span>, we build local authority that drives foot traffic and inquiries.
                            </p>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) 1.2fr', gap: '60px', alignItems: 'center' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '40px', borderRadius: '30px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '30px', color: '#0f172a' }}>Industries We Dominate:</h3>
                            <div className="grid grid-cols-2 gap-4">
                                {industries.map((ind, i) => (
                                    <div key={i} style={{ padding: '20px', background: '#fff', borderRadius: '15px', display: 'flex', gap: '12px', alignItems: 'center', border: '1px solid #e2e8f0' }}>
                                        ...
                                        <span style={{ fontWeight: '600', fontSize: '15px', color: '#0f172a' }}>{ind.name}</span>
                                    </div>
                                ))}
                            </div>
            ...
            <section style={{ padding: '80px 0', backgroundColor: '#f8fafc' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                        <h2 style={{ fontSize: '42px', fontWeight: '700', marginBottom: '20px', color: '#0f172a' }}>Our Local SEO Approach</h2>
                        <p style={{ fontSize: '20px', color: '#64748b', fontWeight: '500' }}>We don't just optimize listings. We build local authority.</p>
                    </div>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '40px' }}>
                        {approach.map((pillar, i) => (
                            <div key={i} style={{
                                ...
                                <h3 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '20px', color: '#0f172a' }}>{pillar.title}</h3>
            ...
            <section style={{ padding: '80px 0', backgroundColor: '#fff' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                        <h2 style={{ fontSize: '42px', fontWeight: '700', marginBottom: '20px', color: '#0f172a' }}>Our Local SEO Process</h2>
                        <p style={{ fontSize: '20px', color: '#64748b' }}>We don’t just list you. We lead you to the top.</p>
                    </div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
                        {localSEOProcess.map((step, i) => (
                            <div key={i} style={{ padding: '40px', background: '#f8fafc', borderRadius: '30px', border: '1px solid #e2e8f0', transition: 'all 0.3s' }}
                                ...
                                <h4 style={{ fontSize: '18px', fontWeight: '700', color: '#0066cc', marginBottom: '15px' }}>{step.t}</h4>
            ...
            <section style={{ padding: '80px 0', backgroundColor: '#0f172a', color: '#fff' }}>
                <div className="container">
                    <h2 style={{ fontSize: '42px', fontWeight: '700', textAlign: 'center', marginBottom: '60px', color: '#fff' }}>What Makes Our Local SEO Different?</h2>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
                        {[
                            ...
                            <div key={i} style={{ padding: '30px', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)' }}>
                                <h4 style={{ fontSize: '20px', fontWeight: '700', color: '#60a5fa', marginBottom: '12px' }}>{item.t}</h4>
            ...
            <section style={{ padding: '80px 0', backgroundColor: '#fff' }}>
                <div className="container">
                    <h2 style={{ fontSize: '42px', fontWeight: '700', textAlign: 'center', marginBottom: '60px', color: '#0f172a' }}>Local SEO Intelligence (FAQs)</h2>
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        {faqs.map((faq, i) => (
                            <div key={i} style={{ marginBottom: '15px', border: '1px solid #e2e8f0', borderRadius: '15px', overflow: 'hidden' }}>
                                ...
                                >
                                    <span style={{ fontSize: '18px', fontWeight: '700', color: '#0f172a', textAlign: 'left' }}>{faq.q}</span>
            ...
            <section style={{ padding: '100px 0', textAlign: 'center', background: 'linear-gradient(135deg, #0066cc 0%, #00458a 100%)', color: '#fff' }}>
                <div className="container">
                    <h2 style={{ fontSize: '56px', fontWeight: '700', marginBottom: '24px' }}>Ready to Dominate Local Search?</h2>
                    ...
                    <Link to="/contact" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', background: '#fff', color: '#0066cc', padding: '20px 60px', borderRadius: '50px', fontSize: '20px', fontWeight: '700', textDecoration: 'none', transition: 'all 0.3s' }}
                        onMouseEnter={(e) => {
