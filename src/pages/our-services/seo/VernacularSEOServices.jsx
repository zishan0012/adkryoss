  ...
  <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full z-10">
    ...
    <div ref={heroContentRef} className="text-left max-w-[650px]">
      ...
      <p className="text-gray-200 text-md md:text-lg leading-relaxed mb-4">
        India's digital growth is happening beyond English.
        From Hindi and Tamil to Bengali, Marathi, Telugu and more —
        regional language searches are exploding across Google,
        YouTube, and voice platforms.
      </p>
      ...
      <p className="text-lg leading-relaxed text-white font-medium mb-8">
        ...
        </span>, we help brands unlock massive untapped regional search demand
        with precision-driven Vernacular SEO strategies that drive traffic,
