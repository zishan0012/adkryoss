    ...
    return (
        <div style={{ backgroundColor: '#fff' }}>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {vernacularFramework.map((item, i) => (
                            <div key={i} style={{
                                ...
                                <p style={{ fontSize: '13px', fontWeight: '600', color: '#0066cc', marginTop: '20px', borderTop: '1px solid #eee', paddingTop: '15px' }}>{item.extra}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section style={{ padding: '100px 0', backgroundColor: '#fff' }}>
                <div className="container">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 style={{ fontSize: '36px', fontWeight: '700', color: '#1a1a1a', marginBottom: '30px' }}>Our Approach: Data + Culture + Performance</h2>
                        ...
                        <div style={{ background: '#0f172a', padding: '60px', borderRadius: '40px', color: '#fff' }}>
                            <h3 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '30px' }}>Why Choose Us?</h3>
            ...
            <section style={{ padding: '100px 0', backgroundColor: '#fff' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                        <h2 style={{ fontSize: '36px', fontWeight: '700', color: '#1a1a1a', marginBottom: '20px' }}>Our Process</h2>
                ...
                <div className="container">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div style={{ background: 'rgba(255,255,255,0.05)', padding: '60px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.1)' }}>
                            ...
                            <h3 style={{ fontSize: '32px', fontWeight: '700', marginBottom: '20px' }}>The Competitive Advantage</h3>
                        ...
                        <div>
                            <h2 style={{ fontSize: '36px', fontWeight: '700', color: '#fff', marginBottom: '30px' }}>Move Before Your Competitors</h2>
            ...
            <section style={{ padding: '80px 0', background: 'linear-gradient(135deg, #0066cc 0%, #004999 100%)', color: '#fff', textAlign: 'center' }}>
                <div className="container">
                    <h2 style={{ fontSize: '42px', fontWeight: '700', marginBottom: '20px', color: '#fff' }}>Let’s Build Your Multilingual Growth Engine</h2>
