  ...
  <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12 w-full relative z-10">
    ...
    <div ref={heroContentRef} className="text-left max-w-[600px]">
      ...
      <p className="text-gray-200 text-md md:text-lg leading-relaxed mb-6">
        When organic traffic drops overnight, revenue follows. A Google penalty
        can severely damage your visibility — but it's not the end.
        <br /><br />
        We diagnose, repair, and engineer long-term search resilience.
        <br /><br />
        At Adkryoss managed by <span className="font-semibold text-white">
        Clink Consultancy Services Private Limited</span>, we rebuild your SEO
        foundation stronger than before.
      </p>
    ...
    <div className="flex justify-center md:justify-end">
      ...
      <div ref={heroImageRef} className="relative group w-full max-w-[450px] h-[260px] sm:h-[300px] md:h-[340px] flex items-center justify-center">
